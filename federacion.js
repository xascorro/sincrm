...
$(".edita_fila").live('click', function() {
	var id = $(this).attr('id');
	$("#fila"+id).load("federacion_edita_fila.php", "id="+id);
	$("#nombre").focus();
});
...
$(".desedita_fila").live('click', function() {
	var id = $(this).attr('id');
	$("#fila"+id).load("federacion_desedita_fila.php", "id="+id);
});
...
$(".borra_fila").live('click', function() {
	...
	//borro entrada de DB
	//TODO
	$("#fila"+id).load("federacion_borra_fila.php", "id="+id);
	//elimino fila
	$("#fila"+id).remove();
});
...
$("#editable-sample_new").live('click', function() {
	...
	$("#nueva_fila").load("federacion_edita_fila.php", "id=nueva_fila");
...
$(".guarda_fila").live('click', function() {
	...
	$.ajax({
	     type:'POST',
	      url:'./federacion_guarda.php',
	      data:'id='+id+'&nombre='+nombre+'&nombre_corto='+nombre_corto+'&codigo='+codigo+'&comunidad='+comunidad+'&logo='+logo,
	...
	$("#fila"+id).load("federacion_lee_fila.php", "id="+id+"&nombre="+nombre+"&nombre_corto="+nombre_corto+'&codigo='+codigo+"&comunidad="+comunidad+"&logo="+logo);
	$("#nueva_fila").load("federacion_lee_fila.php", "id=new&nombre="+nombre+"&nombre_corto="+nombre_corto+'&codigo='+codigo+"&comunidad="+comunidad+"&logo="+logo);
    setTimeout(function() {
