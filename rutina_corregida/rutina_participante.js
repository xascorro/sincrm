...
$(".edita_participante").live('click', function() {
	...
	$("#participante_"+t_r+"_"+id_participante+"_"+id_rutina).load("rutina_edita_participante.php", "t_r="+t_r+"&id_club="+id_club+"&id_participante="+id_participante+"&id_rutina="+id_rutina);
	$("#nombre").focus();
});
