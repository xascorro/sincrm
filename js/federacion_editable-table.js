    ...
    return {
        ...
        init: function () {
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<a class="delete" href="">Borrar</a>', nRow, 6, false);
                oTable.fnDraw();
            }
...
function borra(id){
 //borra un club de la DBi
   $.ajax({
      type:'POST',
      url:'./federacion_borra.php',
      data:'id='+id,
...
function actualiza(nRow){
    ...
    nombre = jqTds[1].innerHTML;
    nombre_corto = jqTds[2].innerHTML,
    comunidad = jqTds[3].innerHTML;
    logo = jqTds[4].innerHTML;
	console.log('id='+id+',nombre='+nombre+',nombre_corto='+nombre_corto+',comunidad='+comunidad+',logo='+logo);
	$.ajax({
	     type:'POST',
	      url:'./federacion_guarda.php',
	      data:'id='+id+'&nombre='+nombre+'&nombre_corto='+nombre_corto+'&comunidad='+comunidad+'&logo='+logo,
	      success:function(data) {
	        if(data) {               
